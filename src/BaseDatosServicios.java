...
public class BaseDatosServicios extends javax.swing.JFrame {
    ...
    public void consultaData() {
        try {
            stmt = BaseDatosServicios.conectar().createStatement();
...
//12:26
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        RegistroCli.jTextField13.setText(selecServi);
        RegistroCli.jTextField14.setText(selecCod);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BaseDatosServicios.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BaseDatosServicios().setVisible(true);
            }
        });
    }
